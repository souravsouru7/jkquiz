...
import { microbiologyQuizData, calculateGrade } from '../data/microbiologyQuizData';

const getQuote = (grade) => {
  const quotes = {
    'A': [
      "Outstanding work! Your microbiology knowledge is exceptional!",
      "Perfect score! You're a true expert in microbial sciences!",
      "Excellent performance! Your understanding of microbiology is remarkable!"
    ],
    'B': [
      "Great job! You have a solid understanding of microbiology!",
      "Well done! Your knowledge of microbial sciences is impressive!",
      "Strong performance! You're on the right track to mastering microbiology!"
    ],
    'C': [
      "Good effort! Keep learning and exploring microbiology!",
      "Not bad! With more study, you'll improve your understanding!",
      "You're getting there! Keep exploring microbial sciences!"
    ],
    'D': [
      "Keep studying! Every attempt brings you closer to mastery!",
      "Don't give up! Learning microbiology takes time and dedication!",
      "You can do better! Review the answers and try again!"
    ],
    'F': [
      "Don't worry! Every expert was once a beginner!",
      "Keep learning! Practice makes perfect in microbiology!",
...
const MicrobiologyQuiz = () => {
  ...
  const currentQuestions = microbiologyQuizData[currentLevel];
...
export default MicrobiologyQuiz; 