...
import { interiorDesignExecutionData, calculateGrade } from '../data/interiorDesignExecutionData';

const getQuote = (grade) => {
  const quotes = {
    'A': [
      "Outstanding work! Your project execution knowledge is exceptional!",
      "Perfect score! You're a true expert in interior design execution!",
      "Excellent performance! Your understanding of project management is remarkable!"
    ],
    'B': [
      "Great job! You have a solid understanding of project execution!",
      "Well done! Your knowledge of interior design implementation is impressive!",
      "Strong performance! You're on the right track to mastering project management!"
    ],
    'C': [
      "Good effort! Keep learning and exploring project execution!",
      "Not bad! With more study, you'll improve your understanding!",
      "You're getting there! Keep exploring project management!"
    ],
    'D': [
      "Keep studying! Every attempt brings you closer to mastery!",
      "Don't give up! Learning project execution takes time and dedication!",
      "You can do better! Review the answers and try again!"
    ],
    'F': [
      "Don't worry! Every expert was once a beginner!",
      "Keep learning! Practice makes perfect in project management!",
...
const InteriorDesignExecutionQuiz = () => {
  ...
  const currentQuestions = interiorDesignExecutionData[currentLevel];
...
export default InteriorDesignExecutionQuiz; 